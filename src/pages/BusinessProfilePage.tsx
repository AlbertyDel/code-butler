...
import { CheckCircle2, AlertTriangle, Loader2, ShieldCheck, MapPin } from 'lucide-react';
    ...
    <Card className="max-w-2xl mx-auto animate-in fade-in duration-500">
      <CardContent className="flex flex-col items-center gap-4 py-16 text-center">
        ...
        <p className="text-sm text-muted-foreground max-w-md">
          Мы передали данные в банк. Обычно проверка занимает 1-2 рабочих дня.
        </p>
      </CardContent>
    </Card>
  );
      ...
      <div ref={formRef} className="max-w-2xl mx-auto">
        <Card>
          ...
          <CardContent className="space-y-6">
            ...
            <Button className="w-full font-semibold" size="lg" disabled={submitting} onClick={handleSubmit}>
